...
<div id="nav">
	...
	<ul><li>通过ID注销</li></ul>
	<p><strong><%out.println(request.getAttribute("message")); %></strong></p>
	<ul><form action="/organizer/deletecriminalbyid" onsubmit="return validate_form(this)" method="post">	
	     通缉犯id: <input type="text" name="cid" size="30" value="${cid }">
		...
		<tbody>
    		...
    		if(list!=null){
				...
				<td style="text-align:left;">
					&nbsp;&nbsp;<a onClick="firm(<%out.println(re.getStr("id"));%>)" >注销</a>
					&nbsp;&nbsp;<a href="/organizer/editcriminal/<%out.println(re.getStr("id"));%>">修改</a>
				</td>
				</tr>
        		<%
        		}
